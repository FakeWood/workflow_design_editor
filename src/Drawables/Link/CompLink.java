...
public class CompLink extends Link{
    ...
    void updateArrow(Port.Side side) {
        ...
        double middleLength = arrowLength * Math.cos(arrowAngle) * 2;
    ...
    public void draw(Graphics g) {
        ...
        g.drawLine(arrowPosLeft.x, arrowPosLeft.y, arrowPosBottom.x, arrowPosBottom.y);
        g.drawLine(arrowPosRight.x, arrowPosRight.y, arrowPosBottom.x, arrowPosBottom.y);
    }
}
